...
export class ApiService {
  ...
  lastClockInTime = `${this.baseUrl}/ClockInOut/LastClockInTime/`;
  ...
  public getLastClockInTime(): Observable<TimeDto> {
    return this.http.get<TimeDto>(this.lastClockInTime + this.id);
  }
}
